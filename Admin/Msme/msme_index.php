                    ...
                    <div class="card mb-3">
                      <div class="card-body">
                        ...
                        <div class="d-flex mb-4 justify-content-center gap-2">
                          ...
                          <a href="productFeedBack.php" class="btn btn-primary w-100 text-white">Monitor Product Feedback</a>
                        </div>
                      </div>
                    </div>
                      ...
                      <div class="card-body">
                        <form method="post" class="mb-4">
                          ...
                          <div class="form-group">
                            <p><span style="font-weight:bold">Note:</span>Select the sentient category to view the product ranking base on the sentient result</p>
