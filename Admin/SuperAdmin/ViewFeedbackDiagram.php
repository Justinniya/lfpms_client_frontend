...
// Fetch feedback data based on the selected product
try {
                            ...
                            <div class="home-tab">
                                <div class="d-sm-flex align-items-center justify-content-between border-bottom">
                                    <ul class="nav nav-tabs" role="tablist">
                                        <li class="nav-item">
                                            <a style="margin-left:5px; margin-top: -35px;  " class="nav-link active ps-0" id="home-tab" data-bs-toggle="tab" href="#overview" role="tab" aria-controls="overview" aria-selected="true">Product Feedback Diagram</a>
                                        </li>
                                    </ul>
                                </div>
                                            ...
                                            <div class="col-md-12 mb-4">
                                                <div class="card">
                                                    <div class="card-header">
                                                        <h5 class="card-title">Product Feedback Diagram</h5>
                                                    </div>
                                                    <div class="card-body">
                                                        <div class="btnAdd d-flex justify-content-end">
                                                            <a href="msmefeedback.php" class="btn btn-success btn-sm text-white">Go Back</a>
                                                        </div>
                                                        ...
                                                        <?php if ($selectedProductId && $feedbackData): ?>
                                                            <h5 class="mt-4">Feedback Summary for <?= $products[array_search($selectedProductId, array_column($products, 'product_id'))]['productName'] ?></h5>
