            ...
            <div class="home-tab">
              <div class="d-sm-flex align-items-center justify-content-between border-bottom">
                <ul class="nav nav-tabs" role="tablist">
                  <li class="nav-item">
                    <a style="margin-left:5px; margin-top: -35px;  " class="nav-link active ps-0" id="home-tab" data-bs-toggle="tab" href="#overview" role="tab" aria-controls="overview" aria-selected="true"> Inbox <span class="mdi mdi-arrow-right-thin"></span> Messages</a>
                  </li>
                </ul>
              </div>
                    ...
                    <div class="tab-pane fade show active" id="overview" role="tabpanel" aria-labelledby="overview">
                      <div class="chat-container">
                        ...
                        <div class="chat-footer">
                            <p class=""><b>Note:</b> Admin Can only Monitor Conversation between Consultant and MSME</p>
                          </div>
                      </div>
                    </div>
                  </div>
