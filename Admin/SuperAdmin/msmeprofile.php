                            ...
                            <div class="card-body">
                              <div class="d-flex flex-column align-items-center text-center">
                                ...
                                <div class="mt-3">
                                  ...
                                  <h5>Total Product: <span style="color:blue; font-size:23px;"><?php echo $totalCount; ?></span></h5>
                                </div>
                              </div>
                            </div>
                          </div>
                  ...
                  <div class="card">
                    <div class="card-body">
                      ...
                      <table id="dataTable" class="table table-striped table-bordered">
                        ...
                        <tbody>
                          <?php
                          if ($userData1 && $stmt1->rowCount() > 0) {
                            while ($row = $stmt1->fetch(PDO::FETCH_ASSOC)) { ?>
                              <tr>
                                <td class="text-center">
                                  <img src="./../uploaded_img/<?= htmlspecialchars($row['productImage']); ?>" alt="Product Image" width="100">
                                </td>
                                <td><?= htmlspecialchars($row['productName']); ?></td>
                                <td>
                                  <div class="text-center">
                                    <form method="post" action="product.php" class="d-inline">
                                      <input type="hidden" name="product_id" value="<?= htmlspecialchars($row['product_id']); ?>">
                                      <button type="submit" class="btn btn-success btn-sm">
                                        <i class="mdi mdi-account-check-outline text-white"> View Product</i>
                                      </button>
                                    </form>
                                  </div>
                                </td>
