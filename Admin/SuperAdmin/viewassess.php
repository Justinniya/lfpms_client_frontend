              ...
              <div class="home-tab">
                <div class="d-sm-flex align-items-center justify-content-between border-bottom">
                  <ul class="nav nav-tabs" role="tablist">
                    <li class="nav-item">
                      <a class="nav-link active ps-0" id="home-tab" data-bs-toggle="tab" href="#overview" role="tab">Assessment Stage <span class="mdi mdi-arrow-right thin"> Step 1</a>
                    </li>
                  </ul>
                </div>
                  ...
                  <div class="card">
                    <div class="card-body">
                      <form id="colorForm" method="POST" action="consultancyQuestionaire.php" onsubmit="return validateForm()" enctype="multipart/form-data">
                        ...
                        <?php
                        if ($Data['status'] == 1) {
                          echo "<p><b>Status:</b> Waiting for your Approval</p>";
                        } else {
                          echo "<p><b>Status:</b> Waiting for Resubmission</p>";
                        }
                        ?>
                        <hr>
                        <div class="form-row">
                      ...
                      <?php if ($Data['status'] != 0): ?>
                        <div class="container mb-2">
                          <form method="POST" action="review_Assessment.php">
                            <label for="decision" class="mb-2">Review Assessment:</label><br>
                            <input name="user_id" type="hidden" value="<?php echo $Data['user_id'] ?>">
                            <button type="submit" name="decision" class="btn btn-primary text-white" value="2">Approve</button>
                            <button type="submit" name="decision" class="btn btn-danger  text-white" value="0">Decline</button>
                          </form>
                          <br>
                        </div>
                      <?php endif; ?>
