...
try {
    $stmt = $conn->prepare("
        SELECT id, 
               'You have a new product development assessment approval pending.' AS message
...
<nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex align-items-top flex-row">
    <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-start">
        ...
        <div>
            <a class="navbar-brand brand-logo" href="superadmin_index.php">
    ...
    <div class="navbar-menu-wrapper d-flex align-items-top">
        <ul class="navbar-nav ms-auto">
            <li class="nav-item dropdown">
                <h5>Welcome Admin, <span class="text-black fw-bold"><?= htmlspecialchars($loggedInUser['fname']); ?>!</span></h5>
            </li>
                        ...
                        <?php if (!empty($notifications)) : ?>
                            <?php foreach ($notifications as $notification) : ?>
                                <a class="dropdown-item preview-item py-3 notification-item"
                                    href="productdevelopment.php">
                                    <div class="preview-thumbnail">
                                        <i class="mdi mdi-alert m-auto text-warning"></i>
                                    </div>
                                    <div class="preview-item-content">
                                        <h6 class="preview-subject fw-normal text-dark mb-1">Product Development Approval Pending</h6>
            ...
            <script>
                $(document).ready(function() {
                    ...
                    $(".notification-item").on("click", function(e) {
                        ...
                        var notificationType = $(this).find("h6").text().trim().toLowerCase(); // Get the notification type
                        var notificationItem = $(this);
                        var redirectUrl = $(this).attr("href"); // Get the target URL
                        ...
                        if (notificationId) {
                            $.ajax({
                                ...
                                data: {
                                    ...
                                    notification_type: (notificationType === "chatroom closed") ? "chat_closed" : "default"
                                },
                                dataType: "json",
                            ...
                            window.location.href = redirectUrl; // Redirect even if there's an issue
                        }
                    });
                });
            </script>
            ...
            <li class="nav-item dropdown d-none d-lg-block user-dropdown">
                <a class="nav-link" id="UserDropdown" href="#" data-bs-toggle="dropdown" aria-expanded="false">
                    <img class="img-xs rounded-circle" src="./../assets/images/img.jpg" height="50" width="50" alt="Profile image"> </a>
                <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
                    <div class="dropdown-header text-center">
                        <img class="img-md rounded-circle" src="./../assets/images/img.jpg" height="50" width="50" alt="Profile image">
