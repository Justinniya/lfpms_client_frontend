              ...
              <div class="home-tab">
                <div class="d-sm-flex align-items-center justify-content-between border-bottom">
                  <ul class="nav nav-tabs" role="tablist">
                    <li class="nav-item">
                      <a class="nav-link active ps-0" id="home-tab" data-bs-toggle="tab" href="#overview" role="tab">Manage Users <span class="mdi mdi-arrow-right-thin"> All Users</a>
                    </li>
                  </ul>
                </div>
                  ...
                  <div class="tab-pane fade show active" id="overview" role="tabpanel">
                    <div class="row">
                      <div class="col-md-12 mb-4">
                        <div class="card">
                          <div class="card-body">
                          <h3 class="mb-4">All Verified Users</h3>
                          <hr>
                                    ...
                                    <tr>
                                      ...
                                      <td>
                                        <div class="btn-group" role="group">                    
                                          <!-- Edit Button -->
                                          <form method="post" action="updateprofile.php" class="d-inline">
