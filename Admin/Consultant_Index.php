        ...
        <div class="navbar-menu-wrapper d-flex align-items-top">
          <ul class="navbar-nav">
            <li class="nav-item fw-semibold d-none d-lg-block ms-0">
              <h1 class="welcome-text">Welcome Consultant, <span class="text-black fw-bold"><?= htmlspecialchars($loggedInUser['fname']); ?>!</span></h1>
              <h3 class="welcome-sub-text">Product Analysis</h3>
            </li>
          </ul>
          ...
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="#tables">
                <i class="menu-icon mdi mdi-card-account-details-star-outline"></i>
                ...
                <div class="home-tab">
                  <div class="d-sm-flex align-items-center justify-content-between border-bottom">
                    <ul class="nav nav-tabs" role="tablist">
                      <li class="nav-item">
                        <a style="margin-left:5px;  " class="nav-link active ps-0" id="home-tab" data-bs-toggle="tab" href="#overview" role="tab" aria-controls="overview" aria-selected="true">Overview</a>
                      </li>
                    </ul>
                    <div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <form method="post" class="mb-4">
                                        <div class="d-flex mb-3 justify-content-between align ">
                                            <a style="color:#fff" href="Sentient analysis.php" class="btn btn-primary me-2">Sentient Analysis</a>
                                            <a style="color:#fff" href="SentientDiagram.php" class="btn btn-primary me-2">View Diagram</a>
                                            <a style="color:#fff" href="ConMonitorFeedBack.php" class="btn btn-primary">Monitor MSME Product Feedback</a>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="msme" id="msme" class="form-control" required onchange="this.form.submit()">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="sentiment" id="sentiment" class="form-control" required onchange="this.form.submit()">
                                    ...
                                    <?php if (!empty($rankedProducts)): ?>
                                        <h4><b>Ranking for <?= htmlspecialchars($selectedSentiment) ?> Sentiment</b></h4>
                                        <table class="table table-bordered table-striped mt-3">
                                            ...
                                            <tbody>
                                                <?php
                                                $ranking = 1;
                                                $previousCount = null; // Track the previous sentiment count
                                                foreach ($rankedProducts as $product):
                                                    if ($previousCount === null || $product['sentiment_count'] !== $previousCount) {
                                                        // Update ranking only if the count changes
                                                        $ranking = $ranking === 1 ? 1 : $ranking + 1; // Increment rank if it's not the first
                                                    }
                                                ?>
                                                    <tr>
                                                        <td><?= $ranking ?></td>
                                                        <td><?= htmlspecialchars($product['productName']) ?></td>
                                                        <td><img src="./uploaded_img/<?= htmlspecialchars($product['productImage']) ?>" alt="Product Image" class="img-fluid" style="max-width: 100px;"></td>
                                                        <td><?= htmlspecialchars($product['sentiment_count']) ?></td>
                                                    </tr>
                                                    <?php
                                                    $previousCount = $product['sentiment_count']; // Update previous count
                                                endforeach; ?>
                                            </tbody>
                                        </table>
